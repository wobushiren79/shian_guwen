...
public class DateTimeSelectorDialogBuilder extends NiftyDialogBuilder implements
	...
	private void initDialog() {
		...
		setDialogProperties();setShowHour(true);
	}
	...
	public void setShowHour(boolean is) {
		isShowHour = is;
		dateWheelView.setShowHour(is);
	}

	private void setDialogProperties() {
		int width = DateUtils.getScreenWidth(context) * 6 / 7;
		if (isShowHour)
			width = DateUtils.getScreenWidth(context) * 11 / 12;

...
public class AuditActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        MHttpManagerFactory.getFuneralManager().getOrderNote(this, params, new HttpResponseHandler<HrGetOrderNote>() {
            ...
            public void onSuccess(HrGetOrderNote result) {
                ...
                tvList.get(5).append(result.getAcceptTime());
                tvList.get(6).append(result.getStartTime());
                tvList.get(7).append(result.getEndTime());
    ...
    void saveData(final View v) {
        ...
        mDialog.setBottomButton("已确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                MHttpManagerFactory.getFuneralManager().auditOrder(AuditActivity.this, params, new HttpResponseHandler<Object>() {

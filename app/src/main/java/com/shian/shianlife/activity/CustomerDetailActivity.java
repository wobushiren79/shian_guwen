...
//	}
    ...
    private void getCustomerPreready() {
        HpConsultIdParams params = new HpConsultIdParams();
        params.setConsultId(consultId);
        MHttpManagerFactory.getFuneralManager().getCustomerPreready(this, params,
...
//                });
        ...
        HpConsultIdParams params = new HpConsultIdParams();
        params.setConsultId(consultId);
        MHttpManagerFactory.getFuneralManager().getCustomerFuneralOther(this, params,
...
//						Toast.makeText(getApplicationContext(), "获取殡仪详情失败！", Toast.LENGTH_SHORT).show();
    ...
    private void getCustomerContract() {
        ...
        params.setConsultId(consultId);
        params.setOrderId(orderId);
        MHttpManagerFactory.getFuneralManager().getCustomerContract(this, params,
...
//						Toast.makeText(getApplicationContext(), "获取合同详情失败！", Toast.LENGTH_SHORT).show();
    ...
    private void getManagerDetail() {
        HpConsultIdParams params = new HpConsultIdParams();
        params.setConsultId(consultId);
        MHttpManagerFactory.getFuneralManager().getCustomerAgentman(this, params,
...
//						Toast.makeText(getApplicationContext(), "获取经办人详情失败！", Toast.LENGTH_SHORT).show();
    ...
    private void getCustomerDeatail() {
        HpConsultIdParams params = new HpConsultIdParams();
        params.setConsultId(consultId);
        MHttpManagerFactory.getFuneralManager().getCustomerUsage(this, params,

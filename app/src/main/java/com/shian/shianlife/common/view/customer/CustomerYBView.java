...
public class CustomerYBView extends BaseCustomerView {
	...
	public void initData() {
		...
		MHttpManagerFactory.getAccountManager().getCustomerPreready(getContext(), params,
	...
	void saveData() {
		...
		MHttpManagerFactory.getAccountManager().saveCustomerPreready(getContext(), params,

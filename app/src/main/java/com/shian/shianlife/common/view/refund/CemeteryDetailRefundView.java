...
public class CemeteryDetailRefundView extends FrameLayout {
	...
	public CemeteryDetailRefundView(Context context) {
		super(context);
		init();
	}
	...
	private void init() {
		...
		findViewById(R.id.tv_setmealCemeteryName).setVisibility(View.GONE);
		findViewById(R.id.ll_xx_3).setVisibility(View.GONE);
	}

...
public class CustomDetailView extends FrameLayout {
    ...
    public void setData(HrGetOrderDetailResult result) {
        ...
        tv_visitNum.appendContent(mBordModel.getVisitNum(), getResources().getColor(R.color.zhy_text_color_1));
        tv_orderNum.append(mBordModel.getOrderNum());
        if (mBordModel.getOrderTime() != null)
            tv_orderTime.append(mBordModel.getOrderTime());
        ...
        if (mBordModel.getFuneralTime() != null)
            tv_funeralTime.append(mBordModel.getFuneralTime());
        if (mBordModel.getStartTime() != null)
            tv_startTime.append(mBordModel.getStartTime());
        if (mBordModel.getEndTime() != null)
            tv_endTime.append(mBordModel.getEndTime());

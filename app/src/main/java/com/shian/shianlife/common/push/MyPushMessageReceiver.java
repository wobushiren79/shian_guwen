...
import com.shian.shianlife.base.BaseActivity.PushReciver;
...
public class MyPushMessageReceiver extends PushMessageReceiver {
	...
	public void onNotificationClicked(Context context, String title,
		...
		Intent in = new Intent(context, MessageDetailActviity.class);
		in.putExtra("isBroadcast", true);
		in.putExtra("message", JSONUtil.writeEntityToJSONString(model));

package com.shian.shianlife.view.taglayout;
...
public class TagLayout extends ViewGroup {
    ...
    private int horizontalSpace;                              //控件之间的间隙
    private int verticalSpace;                                   //行之间的间隙
    ...
    public TagLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        int dp16 = context.getResources().getDimensionPixelOffset(R.dimen.dimen_16dp);
        horizontalSpace = dp16;
        verticalSpace = dp16;
    }

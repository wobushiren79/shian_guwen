...
public class AddedSetMealSelectDialog extends BaseDialog {
    ListView contentListView;
    AddedSetMealSelectAdapter adapter;

    private List<AddedCtgModel> mAddedCtgModels = new ArrayList<>();
    private List<AddedCtgModel> mSelectAddedList = new ArrayList<>();
    private CallBack callback;

    public AddedSetMealSelectDialog(Context context, List<AddedCtgModel> mAddedCtgModels) {
        super(context);
    ...
    private void initListView() {
        ...
        adapter = new AddedSetMealSelectAdapter(getContext(), mAddedCtgModels);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == mTVCancel) {
                AddedSetMealSelectDialog.this.cancel();
            } else if (v == mTVSubmit) {
                saveData();
                AddedSetMealSelectDialog.this.cancel();
            }

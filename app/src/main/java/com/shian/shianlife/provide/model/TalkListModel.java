...
public class TalkListModel {
	...
	private int frBelief;
	private String frBeliefDesc;
	private int frDirection;
	...
	public int getFrBelief() {
		return frBelief;
	}

	public void setFrBelief(int frBelief) {
	...
	public int getFrDirection() {
		return frDirection;
	}

	public void setFrDirection(int frDirection) {

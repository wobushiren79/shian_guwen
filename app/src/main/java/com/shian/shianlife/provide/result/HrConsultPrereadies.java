...
public class HrConsultPrereadies {
	/**
	 * 
	 */
	private List<ConsultPrereadie> consultPrereadies;
	...
	public class ConsultPrereadie {
		/**
		 * "id":150, "consultId":150, "fileName":"string", "fileUrl":"string",
		 * "statusFlag":2
		 */
		private long id;
